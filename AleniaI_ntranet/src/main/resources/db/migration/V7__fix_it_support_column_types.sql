-- Migration V7: Fix IT Support ticket_number column type
-- This fixes a PostgreSQL error where ticket_number was bytea instead of VARCHAR
...
-- Recreate it_support_tickets table with correct types
