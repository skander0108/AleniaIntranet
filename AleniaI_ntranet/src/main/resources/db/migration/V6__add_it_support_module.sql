-- Migration V6: Add IT Support Module
-- Creates tables for IT support ticket system with comments and file attachments
...
-- Create it_support_comments table
...
-- Create it_support_attachments table
