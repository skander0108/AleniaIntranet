...
try {
    ...
    if ($token) {
        ...
        # Test basic "users" or "departments" endpoint just to see what kind of 404/403 we get.
        $urlsToTest = @(
            "https://api-learn.ispringlearn.eu/api/v1/users",
            "https://api-learn.ispringlearn.eu/api/users",
            "https://api-learn.ispringlearn.eu/api/v1/department",
            "https://api-learn.ispringlearn.eu/api/v1/courses"
        )
        ...
        foreach ($url in $urlsToTest) {
            ...
            try {
                ...
                Write-Host ">>> SUCCESS!"
                # print a tiny sample
                $res | Select-Object -First 2 | ConvertTo-Json -Depth 2
            } catch {
