...
@Component({
    selector: 'app-spain-hr',
    standalone: true,
    imports: [CommonModule, FormsModule],
    templateUrl: './spain-hr.component.html',
    styleUrl: './spain-hr.component.css'
})
export class SpainHrComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.hrService.getSpainData().subscribe({
            next: (data) => {
                this.hrData = data;
            ...
            error: () => {
                console.error('Failed to load Spain HR data');
            }
        });
    }
