...
@Component({
    selector: 'app-hr-chat-dashboard',
    standalone: true,
                ...
                <ng-container *ngIf="selectedConversation; else noSelection">
                    ...
                    <div class="flex-1 overflow-y-auto px-5 py-4 space-y-3 bg-gray-50 dark:bg-[#111418]">
                        <div *ngFor="let msg of messages"
                            class="flex" [ngClass]="msg.senderType === 'HR' ? 'justify-end' : 'justify-start'">
                            <!-- Avatar -->
                            <div *ngIf="msg.senderType !== 'HR'" class="shrink-0 mr-2 mt-1">
                            ...
                            <div class="max-w-[70%]">
                                <div *ngIf="msg.senderName && msg.senderType !== 'HR'" class="text-[10px] font-bold mb-0.5 ml-1" [ngClass]="{
                                    'text-primary': msg.senderType === 'BOT',
                                    'text-blue-600': msg.senderType === 'USER'
                                }">{{ msg.senderName }}</div>
                                <div class="px-3.5 py-2.5 rounded-2xl text-sm leading-relaxed whitespace-pre-line"
                                    [ngClass]="msg.senderType === 'HR'
...
export class HrChatDashboardComponent implements OnInit {
    private apiUrl = `${environment.apiUrl}/hr/chat`;
